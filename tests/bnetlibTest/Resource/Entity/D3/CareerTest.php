...
class CareerTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('bnetlib\Resource\Entity\D3\Career\Heroes', self::$obj->getFallenHeroes());
    }
    ...
    {
        $this->assertInstanceOf('bnetlib\Resource\Entity\D3\Career\Progression', self::$obj->getProgression());
    }
    ...
    {
        $this->assertEquals(1339045440, self::$obj->getLastUpdated());
    }
