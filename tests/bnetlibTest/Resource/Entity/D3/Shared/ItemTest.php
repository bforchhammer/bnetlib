...
class ItemTest extends \PHPUnit_Framework_TestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::$obj->populate($data['fallen-heroes'][0]['items']['head']);
    }
    ...
    {
        $this->assertEquals('Adventuring Leather Hood of the Bear', self::$obj->getName());
    }

    public function testIcon()
    {
        $this->assertEquals('helm_002', self::$obj->getIcon());
    }
    ...
    {
        $this->assertEquals('item-data/CKnTmNIIEgcIBBX38E5dHRqWQGAd7O9hBzAJOPQDQABQCGCzBA', self::$obj->getTooltipParams());
    }
