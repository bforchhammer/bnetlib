...
class ItemsTest extends \PHPUnit_Framework_TestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::$obj->populate($data['fallen-heroes'][0]['items']);
    }
    ...
    public function testHasNoShoulders()
    {
        $this->assertFalse(self::$obj->hasShoulders());
    }

    public function testShoulders()
    {
        $this->assertNull(self::$obj->getShoulders());
    }
    ...
    public function testHasNoRightFinger()
    {
        $this->assertFalse(self::$obj->hasRightFinger());
    }

    public function testRightFinger()
    {
        $this->assertNull(self::$obj->getRightFinger());
    }

    public function testHasNoLeftFinger()
    {
        $this->assertFalse(self::$obj->hasLeftFinger());
    }

    public function testLeftFinger()
    {
        $this->assertNull(self::$obj->getLeftFinger());
    }

    public function testHasNoNeck()
    {
        $this->assertFalse(self::$obj->hasNeck());
    }

    public function testNeck()
    {
        $this->assertNull(self::$obj->getNeck());
    }
