...
class HeroTest extends \PHPUnit_Framework_TestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::$obj->populate($data['fallen-heroes'][0]);
    }
    ...
    {
        $this->assertEquals(5, self::$obj->getId());
    }
    ...
    {
        $this->assertInstanceOf('bnetlib\Resource\Entity\D3\FallenHero\Kills', self::$obj->getKills());
    }
