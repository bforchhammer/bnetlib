...
class Item implements ConfigurationInterface
{
     ...
     * @const string
     */
    const RESOURCE_URL = '/api/d3/data/item/%s';
     ...
     * @var array
     */
    protected $requiredArguments = array('item');

    /**
     * @var array
     */
    protected $argumentAliases = array('item' => 'tooltipparam');
    ...
    public function __construct()
    {
        $this->manipulableArguments = array(
            'tooltipparam' => function ($v) {
                return preg_replace('/^item\//', '', $v);
            }
        );
    }
