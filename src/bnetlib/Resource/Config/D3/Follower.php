 ...
 * @license    http://coss.gitbub.com/bnetlib/license.html    MIT License
 */
class Follower implements ConfigurationInterface
{
    /**
     * @const string
     */
    const RESOURCE_URL = '/api/d3/data/follower/%s';
     ...
     * @var array
     */
    protected $requiredArguments = array('type');

    /**
     * @var array
     */
    protected $argumentAliases = array('type' => 'follower');
